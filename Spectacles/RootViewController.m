...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[managedObject valueForKey:@"timeAdded"] description];
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    */
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"Spectacle" inManagedObjectContext:managedObjectContext];
